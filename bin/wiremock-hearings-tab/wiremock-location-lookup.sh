...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Manchester Crown Court (Crown Square)"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Newport (South Wales) Immigration and Asylum Tribunal"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Birmingham Civil and Family Justice Centre"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Harmondsworth Tribunal Hearing Centre"
        },
        "court-type-id": {
            "equalTo": "23"
        }
  ...
  "response": {
      ...
      "jsonBody": [{"court_venue_id":"10271","epimms_id":"28837","site_name":"Harmondsworth Tribunal Hearing Centre","region_id":"1","region":"London","court_type":"Immigration and Asylum Tribunal","court_type_id":"23","cluster_id":null,"cluster_name":null,"open_for_public":"YES","court_address":"Colnbrook Bypass","postcode":"UB7 0HB","phone_number":"","closed_date":null,"court_location_code":"","dx_address":"","welsh_site_name":"","welsh_court_address":"","court_status":"Open","court_open_date":null,"court_name":"Harmondsworth Tribunal Hearing Centre","venue_name":"Harmondsworth","is_case_management_location":"Y","is_hearing_location":"Y","welsh_venue_name":"","is_temporary_location":"N","is_nightingale_court":"N","location_type":"COURT","parent_location":"386417","welsh_court_name":"","uprn":"","venue_ou_code":"","mrd_building_location_id":"MRD-BLD-149","mrd_venue_id":"MRD-CRT-0299","service_url":"","fact_url":"https://www.find-court-tribunal.service.gov.uk/courts/harmondsworth-tribunal-hearing-centre"}]
      }
  }' http://localhost:8991/__admin/mappings/new
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Manchester Crown Court (Minshull St)"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Glasgow Tribunals Centre"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "North Tyneside Magistrates'\'' Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Manchester Tribunal Hearing Centre"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Leeds Magistrates'\'' Court and Family Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Bradford and Keighley Magistrates'\'' Court and Family Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Yarl'\''s Wood Immigration and Asylum Hearing Centre"
        },
        "court-type-id": {
            "equalTo": "23"
        }
  ...
  "response": {
      ...
      "jsonBody": [{"court_venue_id":"10748","epimms_id":"649000","site_name":"Yarl'\''s Wood Immigration and Asylum Hearing Centre","region_id":"5","region":"South East","court_type":"Immigration and Asylum Tribunal","court_type_id":"23","cluster_id":"2","cluster_name":"Bedfordshire, Cambridgeshire, Hertfordshire","open_for_public":"YES","court_address":"Twinwood Road","postcode":"MK44 1FD","phone_number":"","closed_date":null,"court_location_code":"","dx_address":"","welsh_site_name":"","welsh_court_address":"","court_status":"Open","court_open_date":null,"court_name":"Yarls Wood Immigration And Asylum Hearing Centre","venue_name":"Yarl'\''s Wood","is_case_management_location":"Y","is_hearing_location":"Y","welsh_venue_name":"","is_temporary_location":"N","is_nightingale_court":"N","location_type":"COURT","parent_location":"765324","welsh_court_name":"","uprn":"","venue_ou_code":"","mrd_building_location_id":"MRD-BLD-381","mrd_venue_id":"MRD-CRT-0771","service_url":"","fact_url":"https://www.find-court-tribunal.service.gov.uk/courts/yarls-wood-immigration-and-asylum-hearing-centre"}]
      }
  }' http://localhost:8991/__admin/mappings/new
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Bradford Tribunal Hearing Centre"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Hendon Magistrates'\'' Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Taylor House Tribunal Hearing Centre"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Manchester Magistrates'\'' Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Coventry Magistrates'\'' Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Stirling Sheriff Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
...
curl -o /dev/null -s -w "wiremock location lookup: %{http_code}\n" POST \--data '{
    ...
    "queryParameters": {
        "search-string": {
            "equalTo": "Belfast Laganside Court"
        },
        "court-type-id": {
            "equalTo": "23"
        }
