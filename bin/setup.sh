...
./create-role.sh "caseworker-ia-respondentlocalauthority"
./create-role.sh "caseworker-ia-respondentnaab"
...
./ccd-add-access-profile.sh "ia_specific-access-judiciary"
...
./create-user.sh "${TEST_SRCASEOFFICER_USERNAME}" "${IA_USER_PREFIX}Srcase" "Officer" "${TEST_SRCASEOFFICER_PASSWORD}" "caseworker" "[{ \"code\": \"caseworker-ia\"}, { \"code\": \"caseworker-ia-caseofficer\"}, { \"code\": \"caseworker-ia-srcaseofficer\"}, { \"code\": \"payments\"}]"
...
./create-user.sh "${TEST_RESPONDENT_LOCAL_AUTHORITY_USERNAME}" "${IA_USER_PREFIX}Respondent" "LocalAuthority" "${TEST_RESPONDENT_LOCAL_AUTHORITY_PASSWORD}" "caseworker" "[{ \"code\": \"caseworker-ia\"}, { \"code\": \"caseworker-ia-respondentlocalauthority\"}]"
./create-user.sh "${TEST_RESPONDENT_NAAB_USERNAME}" "${IA_USER_PREFIX}Respondent" "NAAB" "${TEST_RESPONDENT_NAAB_PASSWORD}" "caseworker" "[{ \"code\": \"caseworker-ia\"}, { \"code\": \"caseworker-ia-respondentnaab\"}]"
...
./register-role.sh "caseworker-ia-respondentlocalauthority" "$USER_TOKEN" "$SERVICE_TOKEN"
./register-role.sh "caseworker-ia-respondentnaab" "$USER_TOKEN" "$SERVICE_TOKEN"
