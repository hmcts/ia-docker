...
./create-user-simulator.sh "${RAS_SYSTEM_USERNAME}" "${USER_PREFIX}RAS System" "user" "${RAS_SYSTEM_PASSWORD}" "caseworker" "[\"caseworker\", \"caseworker-ia\", \"caseworker-ras-validation\"]"
