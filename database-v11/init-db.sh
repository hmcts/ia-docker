...
for service in idam ccd_user_profile ccd_definition ccd_data evidence ccd_definition_designer ia_case_api ia_timed_event_service camunda role_assignment openidm wa_workflow_api cft_task_db wa_case_event_messages_db hmc_cft_hearing_service; do
